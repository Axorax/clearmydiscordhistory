...
> [!IMPORTANT]
>
> After testing, I found that if you close the app (noconsole version), it may still run in the background. So, make sure to open task manager and end the task. It is pretty easy to spot in the task manager because of the purple icon. I tried to fix this but I couldn't. **This is not a problem with the default app (console version). It only happens in the noconsole version.** For console version, make sure to close both the app and the terminal that is opened.
>
